...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Gridmaster", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Gridmaster</b> version", 0));
...
"Copyright \302\251 2014 The Gridmaster developers", 0));
