...
public:
    ...
    void setupUi(QWidget *MasternodeManager)
    {
        ...
        localButton = new QPushButton(tab_2);
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "BaGMC Tree Count:", 0));
        countLabel->setText(QApplication::translate("MasternodeManager", "0", 0));
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "Masternode Network", 0));
        createButton->setText(QApplication::translate("MasternodeManager", "&Create...", 0));
        localButton->setText(QApplication::translate("MasternodeManager", "Create &Local", 0));
        ...
        ___qtablewidgetitem9->setText(QApplication::translate("MasternodeManager", "Local", 0));
