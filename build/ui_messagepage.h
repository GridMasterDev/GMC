...
public:
    ...
    void retranslateUi(QWidget *MessagePage)
    {
        ...
        newButton->setText(QApplication::translate("MessagePage", "&Send Message", 0));
#ifndef QT_NO_TOOLTIP
        sendButton->setToolTip(QApplication::translate("MessagePage", "Sign a message to prove you own a Gridmaster address", 0));
#endif // QT_NO_TOOLTIP
