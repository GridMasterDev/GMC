...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeGridmasterAmount"))
        settings.setValue("nAnonymizeGridmasterAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeGridmasterAmount = settings.value("nAnonymizeGridmasterAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeGridmasterAmount"))
        SoftSetArg("-anonymizeGridmasteramount", settings.value("nAnonymizeGridmasterAmount").toString().toStdString());
}
