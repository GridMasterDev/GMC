...
{
    resize(998, 640);
    setWindowTitle(tr("Gridmaster") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("Gridmaster");
    setStyleSheet("#Gridmaster { background-image:url(:images/bkg);border:none;font-family:'Open Sans,sans-serif'; } #frame { } QToolBar QLabel { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} QToolBar QLabel:item { padding-top: 0px;padding-bottom: 0px;spacing: 10px;} #spacer2 { background:rgb(65,84,101);border:none; } #spacer { background:rgb(0,70,101);border:none; } #toolbar2 { border:none;width:0px;hight:0px;padding-top:0px;padding-bottom:0px; background-color:rgb(51,69,83); } #toolbar { border:1px;height:100%;padding-top:20px; background: rgb(0,70,101); text-align: left; color: white;min-width:100px;max-width:100px;} QToolBar QToolButton:hover {background-color: rgb(84,142,168);} QToolBar QToolButton:checked {background-color: rgb(26,89,117);}"
#ifdef Q_OS_MAC
...
#else
"QToolBar QToolButton { font-family:Ubuntu;font-size:16px;padding-left:20px;padding-right:70px;padding-top:5px;padding-bottom:5px; width:100%; color: rgb(255,255,255); text-align: left; background-color: rgb(0,70,101);  }"
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Gridmaster address"));
    ...
    masternodeManagerAction->setToolTip(tr("Show Gridmaster Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About Gridmaster"), this);
    aboutAction->setToolTip(tr("Show information about Gridmaster"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Gridmaster"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #ffffff; } QToolButton:hover { background-color: #f9a6a6 } QToolButton:checked { background-color: #c34646} QToolButton:pressed { background-color: #c34646} #tabs { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #404040, stop: 1 #101010);  }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Gridmaster client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Gridmaster client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gridmaster network", "", count));
}
...
{
    QString strTitle = tr("Gridmaster") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Gridmaster address or malformed URI parameters."));
    }
