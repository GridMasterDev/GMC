...
const string strMessageMagic = "Gridmaster Signed Message:\n";
...
static const int g_RewardHalvingPeriod = 1000000; //every 1.90 years
...
if(nHeight < 8640)
  ...
  else if(nHeight < 10000) // PoS Reward starts 6th day
  {
      nSubsidy = 3000 * COIN;
  }
  else if(nHeight < 10250)
  {
      nSubsidy = 4500 * COIN;
  }
  else if(nHeight < 11500)
  {
      nSubsidy = 19000 * COIN;
  }
...
{
    RenameThread("Gridmaster-loadblk");
